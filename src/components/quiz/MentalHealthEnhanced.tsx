          ...
          >
            ...
            <AnimatePresence>
              <motion.div 
                ...
                exit="exit"
              >
                <div className="bg-primary text-primary-foreground rounded-lg px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm max-w-[85%] sm:max-w-[80%]">
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {allDone && (
          <motion.div 
            className="p-3 sm:p-4 border-t bg-green-500/10 border-green-500/30"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
